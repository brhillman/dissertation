...
%, and condensate variability and overlap parameters are parameterized using a combination of high-resolution global model output from the SP-CAM and observations from the CloudSat and CALIPSO [?].
