...
As stated by @pincus_et_al_2012 and mentioned in [@sec:introductionChapter],
...
As discussed in [@sec:introductionChapter], the first step in simulating
...
[@sec:subgrid1Framework]. [@fig:subgrid1_cldmisr_maps_diff] shows the total
...
surprising given the discussion in [@sec:subgrid1Framework] in the context of
