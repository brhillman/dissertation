...
Figure~\ref{fig:cldmisrMapsMro} shows MISR-simulated monthly-mean total
...
\begin{figure}[htbp]
\centering
\includegraphics{graphics/subgrid1_cldisccp_maps_diff.png}
...
Figure~\ref{fig:hfbaZonalMro} shows simulated zonal-mean hydrometeor
