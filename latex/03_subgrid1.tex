...
\begin{figure}[tp]
\centering
\includegraphics{graphics/mxratio_example_mro-hom.pdf}
...
The sensitivities of the COSP diagnostics to occurrence overlap,
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/cldmisr_maps_mro-hom.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/cldmisr_maps_mro-hom_diff.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/taudist_crm-hom.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/cldmisrthick_maps_mro-hom_diff.pdf}
...
While errors due to homogenizing cloud condensate are primarily
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/cldisccp_maps_mro-hom_diff.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/hfba_zonal_mro-hom.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/hfba_zonal_mro-hom_diff.pdf}
...
Figure~\ref{fig:hfba_zonal_mro} shows simulated zonal-mean hydrometeor
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/cfadDbze94_NHTropics_mro-hom.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/cfadDbze94_NHTropics_mro-hom_diff.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics{graphics/cfadDbze94_att-test.pdf}
